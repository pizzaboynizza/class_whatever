...
num_dot = 0
while not valid_distance:#make sure they enter a string with digits and only 1 period
...
if units_org == 'ft':#This converts units_org to m. There is no case for m since if units are already in m we don't need to 
    #convert to m
    distance_m *= 0.3048
elif units_org == 'km':
    distance_m *= 1000
...
if units_final == 'ft':#This converts from m to units_final. There is no case for m since units are already in m.
