...
img = Image.open("/home/michael/Desktop/Lenna_(test_image).png")
width, height = img.size
pixels = img.load()
...
for i in range(width):
    for j in range(height):
        ...
        # your code here
        # increase the saturation, decrease the brightness, and rotate the hue
        # colorsys uses colors in the range [0, 1]
        h, s, v = colorsys.rgb_to_hsv(r/255, g/255, b/255)
...
# draw a rectangle from x0, y0 to x1, y1
draw.rectangle(((width*0.4, height*0.05), (width*0.6, height*0.25)), fill="lightblue")
# using the color pink
color = (256, 128, 128)  # pink
draw.line((width*0.5, height*0.25, width*0.5, height*0.7), fill=color)
draw.line((width*0.5, height*0.7, width*0.4, height), fill=color)
draw.line((width*0.5, height*0.7, width*0.6, height), fill=color)
draw.line((width*0.5, height*0.35, width*0.4, height*0.6), fill=color)
draw.line((width*0.5, height*0.35, width*0.6, height*0.6), fill=color)

# circle_x = width/2
# circle_y = height/2
# circle_radius = 100
# draw.ellipse((circle_x-circle_radius, circle_y-circle_radius, circle_x+circle_radius, circle_y+circle_radius), fill='light  green')
